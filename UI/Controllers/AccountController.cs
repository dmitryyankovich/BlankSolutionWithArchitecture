...
namespace UI.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IUnitOfWork uow, ApplicationUserManager userManager, ApplicationSignInManager manager)
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleName = model.IsCustomer ? "CustomerAdministrator" : "RegularUser";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Report It Password Reset", EmailBodyHelper.GetForgotPasswordBody(callbackUrl));
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            {
                ModelState.AddModelError("", "Cannot reuse last password");
                return View(model);
            }
